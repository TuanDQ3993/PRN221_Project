...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasIndex(e => e.AuthorName, "UQ__Authors__4A1A120BA00A17CF")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.Isbn, "UQ__Books__447D36EA64368CCA")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.CategoryName, "UQ__Categori__8517B2E08D27F98C")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.PublisherName, "UQ__Publishe__5F0E22499ABAAE74")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.Email, "UQ__Users__A9D1053476CCE1F1")
                    .IsUnique();
